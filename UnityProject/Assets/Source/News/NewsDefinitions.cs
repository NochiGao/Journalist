...
new News( 	17	,	"Por romper el cascarón"	,	"La hija del General Alcatraz está a punto de romper el cascarón. Será feriado nacional."	,	""	,	-0.03	,	-0.01	,	0.02	,	0.03	,	-0.01	,	0.01	,	0	, new List<int>() {		}, new List<int>(){		}	),
...
new News( 	26	,	"Murió manifestante"	,	"Roberto Picchotti, hornero constructor, murió en la dura represión del régimen de Alcatraz."	,	""	,	0.03	,	0.06	,	-0.03	,	-0.02	,	-0.1	,	-0.02	,	0	, new List<int>() {	25	}, new List<int>(){		}	),
...
new News( 	29	,	"Jubilado rebelde"	,	"Jubilado asalta a efectivos policiales mientras intentaban contener una turba enfurecida."	,	""	,	-0.05	,	-0.01	,	0	,	0.01	,	-0.02	,	-0.01	,	0	, new List<int>() {		}, new List<int>(){		}	),
new News( 	30	,	"Mas vale pájaro en mano"	,	"La policía actuó rápidamente capturando a un malhechor en pleno acto, declaro que fue gracias al gran entrenamiento policial."	,	""	,	-0.04	,	-0.01	,	0.01	,	0.02	,	0.01	,	0.04	,	0	, new List<int>() {		}, new List<int>(){		}	),
...
new News( 	34	,	"Escándalo por docena"	,	"Caranchotti in fraganti recostado sobre maple de huevos. Impunidad total en altos funcionarios del gobierno"	,	""	,	-0.04	,	-0.01	,	0.01	,	0.02	,	-0.02	,	0.02	,	0	, new List<int>() {	32	}, new List<int>(){	33	}	),
...
new News( 	52	,	"Dictador clausura el congreso"	,	"En ataque contra la democracia, se clausuran las sesiones del congreso a la fuerza. Pajaronia acongojada."	,	""	,	0.05	,	0.05	,	-0.1	,	-0.1	,	-0.06	,	-0.02	,	7	, new List<int>() {		}, new List<int>(){		}	),
new News( 	53	,	"Congreso traidor obtiene su merecido"	,	"El Presidente General Alcatraz clausura las sesiones del traidor Congreso. Pueblo festeja. Diputados enviados a sus casa."	,	""	,	-0.1	,	-0.05	,	0.05	,	0.1	,	0.02	,	0.06	,	7	, new List<int>() {		}, new List<int>(){		}	),
new News( 	54	,	"Presidente Alcatraz nacionaliza YLF"	,	"Yacimientos Lombricisticos Fiscales vuelve a ser del pueblo, tras 50 años de estas en manos extranjeras."	,	""	,	-0.05	,	-0.01	,	0.01	,	0.05	,	0.02	,	0.1	,	0	, new List<int>() {		}, new List<int>(){		}	),
new News( 	55	,	"Fondos Buitres amenazan a Pajaronia"	,	"Fondos Buitres amenazan a Pajaronia, pero el presidente Alcatraz contesta que jamás pagaremos a los buitres."	,	""	,	-0.05	,	-0.01	,	0.01	,	0.05	,	0.02	,	0.06	,	0	, new List<int>() {		}, new List<int>(){		}	),
new News( 	56	,	"Presidente propone nueva bandera"	,	"El presidente Alcatraz propone una nueva bandera para Pajaronia. Es un hermoso diseño."	,	""	,	-0.02	,	-0.01	,	0.05	,	0.1	,	0.01	,	0.04	,	0	, new List<int>() {		}, new List<int>(){		}	),
...
new News( 	58	,	"Lo que el país necesita"	,	"Intelectuales del Instituto Pelícano sostienen que la clausura del Congreso es lo que el país necesita para salir adelante"	,	""	,	-0.02	,	-0.01	,	0.05	,	0.1	,	0.02	,	0.04	,	0	, new List<int>() {		}, new List<int>(){		}	),
...
new News( 	60	,	"Cuervos extasiados"	,	"Cuervos en éxtasis ante posibilidad de nuevos negocios con el gobierno, sostienen que crecerá el empleo."	,	""	,	-0.02	,	-0.01	,	0.05	,	0.1	,	0.02	,	0.04	,	0	, new List<int>() {		}, new List<int>(){		}	),
new News( 	61	,	"Alpiste para tod@s"	,	"El nuevo gobierno entrega alpiste y elementos de la canasta familiar a las familias mas necesitadas."	,	""	,	-0.02	,	-0.01	,	0.05	,	0.1	,	0.01	,	0.06	,	0	, new List<int>() {		}, new List<int>(){		}	),
new News( 	62	,	"Notebooks para tod@s"	,	"El nuevo gobierno entrega notebooks a los pichones para acelerar su educación."	,	""	,	-0.02	,	-0.01	,	0.05	,	0.1	,	0.01	,	0.05	,	0	, new List<int>() {		}, new List<int>(){		}	),
new News( 	63	,	"Planes para tod@s"	,	"El nuevo gobierno entregara planes familiares de vivienda a las familias mas carenciadas."	,	""	,	-0.02	,	-0.01	,	0.05	,	0.1	,	0.01	,	0.06	,	0	, new List<int>() {		}, new List<int>(){		}	),
new News( 	64	,	"Dolares para tod@s"	,	"Se podrán obtener dolares en los bebederos y fuentes de la nación."	,	""	,	-0.02	,	-0.01	,	0.05	,	0.1	,	0.01	,	0.04	,	0	, new List<int>() {		}, new List<int>(){		}	),
new News( 	65	,	"Le Prefum"	,	"La esposa del presidente da a conocer su nueva línea de perfumes."	,	""	,	-0.02	,	-0.01	,	0.05	,	0.1	,	0.01	,	0.03	,	0	, new List<int>() {		}, new List<int>(){		}	),
new News( 	66	,	"Cacona Voladora"	,	"Se levanto la prohibición para mover el intestino mientras se vuela."	,	""	,	-0.02	,	-0.01	,	0.05	,	0.1	,	0.01	,	0.03	,	0	, new List<int>() {		}, new List<int>(){		}	),
new News( 	67	,	"Cacona Generadora"	,	"Se contratan 200 empleados para limpiar la cacona venidera."	,	""	,	-0.02	,	-0.01	,	0.05	,	0.1	,	0.01	,	0.03	,	0	, new List<int>() {	66	}, new List<int>(){		}	),
new News( 	68	,	"Nuevos parajes"	,	"La isla de los murciélagos abre sus puertas."	,	""	,	-0.02	,	-0.01	,	0.05	,	0.1	,	0.01	,	0.03	,	0	, new List<int>() {		}, new List<int>(){		}	),
new News( 	69	,	"Sale y vale"	,	 "Se cierra trato con Mucielandia para visitas guiadas durante el día, el presidente afirma que todos nos beneficiaremos de este acuerdo."	,	""	,	-0.02	,	-0.01	,	0.05	,	0.1	,	0.01	,	0.03	,	0	, new List<int>() {	68	}, new List<int>(){		}	),
...
new News( 	73	,	"Carnaval Carioca"	,	"Como todos los años se festejara el carnaval en el sambódromo del Avestruz atrevido."	,	""	,	-0.01	,	0.02	,	-0.01	,	0.02	,	0	,	0	,	0	, new List<int>() {		}, new List<int>(){		}	),
new News( 	74	,	"Inversiones"	,	"El gobierno invierte en investigación aviar."	,	""	,	0	,	0.02	,	0.01	,	0.04	,	0.02	,	0.05	,	0	, new List<int>() {		}, new List<int>(){		}	),
new News( 	75	,	"Júbilo para los jubilados"	,	"Se aumentará la jubilación, abuelos felices."	,	""	,	-0.02	,	-0.01	,	0.05	,	0.1	,	0.01	,	0.05	,	0	, new List<int>() {		}, new List<int>(){		}	),
new News( 	76	,	"Apoyo de los Estados Halconísticos"	,	"El embajador Hawkins de los EEHH manifestó su apoyo al General Alcatraz. Es lo que Pajaronia necesita, manifestó."	,	""	,	-0.02	,	-0.01	,	0.05	,	0.1	,	0.01	,	0.04	,	0	, new List<int>() {	77	}, new List<int>(){		}	),
new News( 	77	,	"Confirma el Presidente el nuevo gabinete"	,	"El nuevo gabinete estará conformado por diferentes amigos del nuevo Presidente, todos altamente capacitados."	,	""	,	-0.04	,	-0.01	,	0.01	,	0.02	,	0.01	,	0.03	,	0	, new List<int>() {		}, new List<int>(){		}	),
new News( 	78	,	"Tensión en la Región"	,	"Los vecinos países del Aladosur, se mantienen en alerta tras el golpe de estado del General Alcatraz."	,	""	,	0.01	,	0.04	,	0.01	,	0.04	,	-0.05	,	0.05	,	0	, new List<int>() {		}, new List<int>(){		}	),
...
new News( 	81	,	"ExPresidente Palometa, exiliado en Murcielandia"	,	"El ExPresidente fue recibido por autoridades de Murcielandia, en donde se encuentra exiliado."	,	""	,	0.03	,	0.06	,	-0.03	,	-0.02	,	-0.1	,	-0.02	,	0	, new List<int>() {		}, new List<int>(){		}	),
new News( 	82	,	"Devastadoras declaraciones de ExPresidente Palometa"	,	"Dijo: Me taparon los ojos, y me obligaron a dejar el palacio presidencial. Es un golpe de lo mas ruin."	,	""	,	0.03	,	0.06	,	-0.03	,	-0.02	,	-0.1	,	-0.02	,	81	, new List<int>() {		}, new List<int>(){		}	),
new News( 	83	,	"ExPresidente Palometa se ha suicidado"	,	"Fue encontrado en dudosas circunstancias. El peritaje inicial no es concluyente."	,	""	,	0.03	,	0.06	,	-0.03	,	-0.02	,	-0.1	,	-0.02	,	82	, new List<int>() {		}, new List<int>(){		}	),
new News( 	84	,	"Autopsia de Palometa"	,	"Los resultados indican que se trataría de un magnicidio, servicios de inteligencia de Alcatraz, sospechados."	,	""	,	0.03	,	0.06	,	-0.03	,	-0.02	,	-0.1	,	-0.02	,	83	, new List<int>() {		}, new List<int>(){		}	),
new News( 	85	,	"La autopsia de Palometa es un circo"	,	"Expertos internacionales indican que la autopsia es un circo, que indiscutiblemente fue suicidio por la situación en la que dejó el país."	,	""	,	-0.04	,	-0.01	,	0.01	,	0.02	,	0.01	,	0.04	,	83	, new List<int>() {		}, new List<int>(){		}	),
new News( 	86	,	"¿Inflación?"	,	"Los precios empiezan a incrementarse en el régimen Alcatrazista."	,	""	,	0.03	,	0.06	,	-0.03	,	-0.02	,	-0.1	,	-0.02	,	0	, new List<int>() {		}, new List<int>(){		}	),
new News( 	87	,	"Devaluación"	,	"La moneda comienza a devaluarse. Todos lo ahorristas, perdieron poder adquisitivo."	,	""	,	0.03	,	0.06	,	-0.03	,	-0.02	,	-0.1	,	-0.02	,	0	, new List<int>() {		}, new List<int>(){		}	),
new News( 	88	,	"Nuevos jueces"	,	"El gobierno ha designado nuevos jueces que responderían directamente al régimen Alcatrazista."	,	""	,	0.03	,	0.06	,	-0.03	,	-0.02	,	-0.1	,	-0.02	,	0	, new List<int>() {		}, new List<int>(){		}	),
new News( 	89	,	"Juicio a dirigentes de la oposición"	,	"Nuevos jueces Alcatrazistas designados por sorteo para juzgar a dirigentes de la oposición. Fallo inminente."	,	""	,	0.03	,	0.06	,	-0.03	,	-0.02	,	-0.1	,	-0.02	,	88	, new List<int>() {		}, new List<int>(){		}	),
new News( 	90	,	"Traición a la Patria"	,	"Dirigentes de la oposición al régimen Alcatrazista son encontrados culpables de traición a la Patria por los flamantes jueces."	,	""	,	0.03	,	0.06	,	-0.03	,	-0.02	,	-0.1	,	-0.02	,	89	, new List<int>() {		}, new List<int>(){		}	),
    };
