...
new News( 	"Romance confirmado"	,	"Se vio volando junto a Paloma Herrera y el Pájaro Caniggia. Todo es hermoso."	,	0	,	0	,	0	,	0	,	0	,	0	),
new News( 	"Paro de gallos madrugadores"	,	"El pueblo llega tarde a sus trabajos mientras los gallos reclaman aumento."	,	0.02	,	0.04	,	-0.02	,	-0.03	,	-0.01	,	-0.03	),
new News( 	"Huelga de pelícanos"	,	"Escasean los peces, el pueblo debe recurrir a alimentarse solamente de semillas."	,	0.01	,	0.03	,	-0.01	,	-0.03	,	-0.01	,	-0.02	),
new News( 	"Retraso de cigüeñas"	,	"El crecimiento poblacional decae, cae el precio del metro cuadrado de nido."	,	0.01	,	0.03	,	-0.01	,	-0.03	,	-0.01	,	-0.02	),
new News( 	"Pajaronia sede"	,	"La ciudad capital será la anfitriona de los Juegos Aviolimpicos. Grandes espectativas de turismo."	,	0.01	,	0.02	,	0.01	,	0.05	,	0.01	,	0.03	),
...
new News( 	"Caranchotti pide disculpas"	,	"Caranchotti pide disculpas y dice, quien no se comió un huevo crudo alguna vez?"	,	-0.03	,	-0.06	,	0.01	,	0.02	,	-0.01	,	-0.02	),
