...
new News( 	31	,	"Corre riesgo la libertad de prensa"	,	"Fuentes cercanas al gobierno revelaron el plan de expropiación de los medios opositores. Alerta en organismos de libertad de prensa."	,	""	,	0.03	,	0.06	,	-0.01	,	-0.02	,	-0.04	,	-0.02	,	18	, new List<int>() {	52	}, new List<int>(){		}	),
...
new News( 	52	,	"Dictador clausura el congreso"	,	"En ataque contra la democracia, se clausuran las sesiones del congreso a la fuerza. Pajaronia acongojada."	,	""	,	0.05	,	0.1	,	-0.2	,	-0.1	,	-0.04	,	-0.02	,	7	, new List<int>() {		}, new List<int>(){		}	),
