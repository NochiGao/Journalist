...
new News( 	31	,	"Corre riesgo la libertad de prensa"	,	"Fuentes cercanas al gobierno revelaron el plan de expropiación de los medios opositores. Alerta en organismos de libertad de prensa."	,	""	,	0.03	,	0.06	,	-0.01	,	-0.02	,	-0.04	,	-0.02	,	15	, new List<int>() {	52	}, new List<int>(){		}	),
...
new News( 	52	,	"Dictador clausura el congreso"	,	"En ataque contra la democracia, se clausuran las sesiones del congreso a la fuerza. Pajaronia acongojada."	,	""	,	0.05	,	0.1	,	-0.2	,	-0.1	,	-0.04	,	-0.02	,	5	, new List<int>() {		}, new List<int>(){		}	),
new News( 	53	,	"Congreso traidor obtiene su merecido"	,	"El Presidente General Albatros clausura las sesiones del traidor Congreso. Pueblo festeja. Diputados enviados a sus casa."	,	""	,	-0.2	,	-0.1	,	0.05	,	0.1	,	0.01	,	0.02	,	5	, new List<int>() {		}, new List<int>(){		}	),
...
new News( 	57	,	"Clausura del Congreso de alta gravedad"	,	"Constitucionalista Cormorán Gutiérrez sostiene que la clausura del congreso afecta seriamente las chances de la vuelta de la democracia"	,	""	,	0.03	,	0.06	,	-0.03	,	-0.02	,	-0.04	,	-0.02	,	0	, new List<int>() {	52	}, new List<int>(){		}	),
...
new News( 	59	,	 "Flamencos preocupados"	,	"Flamencos manifiestan preocupación frente al avance ante derechos civiles."	,	""	,	0.03	,	0.06	,	-0.03	,	-0.02	,	-0.04	,	-0.02	,	0	, new List<int>() {		}, new List<int>(){		}	),
...
new News( 	61	,	"Alpiste para tod@s"	,	"El gobierno entrega alpiste y elementos de la canaste familiar a las familias mas necesitadas."	,	""	,	-0.02	,	-0.01	,	0.05	,	0.1	,	0.01	,	0.02	,	0	, new List<int>() {		}, new List<int>(){		}	),
new News( 	62	,	"Notebooks para tod@s"	,	"El gobierno entrega notebooks a los pichones para acelerar su educación."	,	""	,	-0.02	,	-0.01	,	0.05	,	0.1	,	0.01	,	0.02	,	0	, new List<int>() {		}, new List<int>(){		}	),
new News( 	63	,	"Planes para tod@s"	,	"El gobierno entregara planes familiares de vivienda a las familias mas carenciadas."	,	""	,	-0.02	,	-0.01	,	0.05	,	0.1	,	0.01	,	0.02	,	0	, new List<int>() {		}, new List<int>(){		}	),
...
new News( 	70	,	"Mar del Cobre"	,	"El teatro de revistas en su auge, los turistas invaden las playas."	,	""	,	-0.01	,	0.01	,	-0.01	,	0.01	,	0	,	0	,	0	, new List<int>() {		}, new List<int>(){		}	),
new News( 	71	,	"Marcha de pavos reales"	,	"Muestran orgullosamente sus plumas durante este fin de semana."	,	""	,	-0.01	,	0.01	,	-0.01	,	0.01	,	0	,	0	,	0	, new List<int>() {		}, new List<int>(){		}	),
new News( 	72	,	"Los esperados colibríes"	,	"Los hermosos Colibríes realizaran su tan ansiado baile anual en la plaza San Cotorra"	,	""	,	-0.01	,	0.01	,	-0.01	,	0.01	,	0	,	0	,	0	, new List<int>() {		}, new List<int>(){		}	),
new News( 	73	,	"Carnaval Carioca"	,	"Como todos los años se festejara el carnaval en el sambodromo del Avestruz atrevido."	,	""	,	-0.01	,	0.01	,	-0.01	,	0.01	,	0	,	0	,	0	, new List<int>() {		}, new List<int>(){		}	),
new News( 	74	,	"Inversiones"	,	"El gobierno invierte en investigación aviar."	,	""	,	-0.01	,	0.01	,	-0.01	,	0.01	,	0	,	0	,	0	, new List<int>() {		}, new List<int>(){		}	),
new News( 	75	,	"Júbilo para los jubilados"	,	"Se aumentara la jubilación, abuelos felices."	,	""	,	-0.01	,	0.01	,	-0.01	,	0.01	,	0	,	0	,	0	, new List<int>() {		}, new List<int>(){		}	),
...
new News( 	79	,	 "Estado de Sitio"	,	"El Gobierno decretó el estado de sitio, con toque de queda desde las 9PM hasta las 5AM."	,	""	,	-0.01	,	0.01	,	-0.01	,	0.01	,	-0.1	,	0	,	10	, new List<int>() {		}, new List<int>(){		}	),
new News( 	80	,	"Ajusticiamiento"	,	"Rumores indicarían que tropas afines al gobierno habrían ajusticiado a diferentes opositores."	,	""	,	0.03	,	0.06	,	-0.03	,	-0.02	,	-0.04	,	-0.02	,	0	, new List<int>() {		}, new List<int>(){		}	),
