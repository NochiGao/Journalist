...
new News( 	1	,	"Gloriosa Revolución"	,	"El General Albatros toma la presidencia y libera a la nación del oloroso Presidente Palometa. Algarabía en las calles."	,	""	,	-0.2	,	-0.1	,	0.1	,	0.2	,	0	,	0	,	1	, new List<int>( 		), new List<int>(		)	),
new News( 	2	,	"Sangrientos enfrentamientos"	,	"Los enfrentamientos liderados por el impostor Albatros ensangrentan la ciudad. Pesimismo en las calles."	,	""	,	0.1	,	0.2	,	-0.2	,	-0.1	,	0	,	0	,	1	, new List<int>( 		), new List<int>(		)	),
...
new News( 	11	,	"Renuncian a Caranchotti"	,	"Tras haber sido encontrado con estupefacientes y menores ilegales, Jefe de Gabinete renuncia en medio de un escándalo."	,	""	,	0.01	,	0.04	,	0.01	,	0.04	,	-0.05	,	0.05	,	0	, new List<int>( 		), new List<int>(		)	),
new News( 	12	,	"Caranchotti pide disculpas"	,	"Caranchotti pide disculpas y dice, quien no se comió un huevo crudo alguna vez?"	,	""	,	-0.06	,	-0.03	,	0.01	,	0.02	,	-0.02	,	-0.01	,	0	, new List<int>( 		), new List<int>(		)	),
