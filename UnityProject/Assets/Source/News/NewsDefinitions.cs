...
new News( 	30	,	"Mas vale pájaro en mano"	,	"La policía actuó rápidamente capturando a un malechor en pleno acto, declaro que fue gracias al gran entrenamiento policial."	,	""	,	-0.04	,	-0.01	,	0.01	,	0.02	,	0.01	,	0.03	,	0	, new List<int>() {		}, new List<int>(){		}	),
...
new News( 	53	,	"Congreso traidor obtiene su merecido"	,	"El Presidente General Albatros clausura las sesiones del traidor Congreso. Pueblo festeja. Diputados enviados a sus casa."	,	""	,	-0.2	,	-0.1	,	0.05	,	0.1	,	0.02	,	0.03	,	7	, new List<int>() {		}, new List<int>(){		}	),
...
new News( 	56	,	"Presidente propone nueva bandera"	,	"El presidente Albatros propone una nueva bandera para Pajaronia. Es un hermoso diseño."	,	""	,	-0.02	,	-0.01	,	0.05	,	0.1	,	0.01	,	0.03	,	0	, new List<int>() {		}, new List<int>(){		}	),
...
new News( 	58	,	"Lo que el país necesita"	,	"Intelectuales del Instituto Pelícano sostienen que la clausura del Congreso es lo que el país necesita para salir adelante"	,	""	,	-0.02	,	-0.01	,	0.05	,	0.1	,	0.01	,	0.03	,	0	, new List<int>() {		}, new List<int>(){		}	),
...
new News( 	60	,	"Cuervos extasiados"	,	"Cuervos en éxtasis ante posibilidad de nuevos negocios con el gobierno, sostienen que crecerá el empleo."	,	""	,	-0.02	,	-0.01	,	0.05	,	0.1	,	0.01	,	0.03	,	0	, new List<int>() {		}, new List<int>(){		}	),
new News( 	61	,	"Alpiste para tod@s"	,	"El nuevo gobierno entrega alpiste y elementos de la canaste familiar a las familias mas necesitadas."	,	""	,	-0.02	,	-0.01	,	0.05	,	0.1	,	0.01	,	0.03	,	0	, new List<int>() {		}, new List<int>(){		}	),
new News( 	62	,	"Notebooks para tod@s"	,	"El nuevo gobierno entrega notebooks a los pichones para acelerar su educación."	,	""	,	-0.02	,	-0.01	,	0.05	,	0.1	,	0.01	,	0.03	,	0	, new List<int>() {		}, new List<int>(){		}	),
new News( 	63	,	"Planes para tod@s"	,	"El nuevo gobierno entregara planes familiares de vivienda a las familias mas carenciadas."	,	""	,	-0.02	,	-0.01	,	0.05	,	0.1	,	0.01	,	0.03	,	0	, new List<int>() {		}, new List<int>(){		}	),
new News( 	64	,	"Dolares para tod@s"	,	"Se podran obtener dolares en los bebederos y fuentes de la nación."	,	""	,	-0.02	,	-0.01	,	0.05	,	0.1	,	0.01	,	0.03	,	0	, new List<int>() {		}, new List<int>(){		}	),
...
new News( 	68	,	"Nuevos parajes"	,	"La isla de los murcielagos abre sus puertas."	,	""	,	-0.02	,	-0.01	,	0.05	,	0.1	,	0.01	,	0.03	,	0	, new List<int>() {		}, new List<int>(){		}	),
...
new News( 	75	,	"Júbilo para los jubilados"	,	"Se aumentara la jubilación, abuelos felices."	,	""	,	-0.02	,	-0.01	,	0.05	,	0.1	,	0.01	,	0.03	,	0	, new List<int>() {		}, new List<int>(){		}	),
new News( 	76	,	"Apoyo de los Estados Halconísticos"	,	"El embajador Hawkins de los EEHH manifestó su apoyo al General Albatros. Es lo que Pajaronia necesita, manifestó."	,	""	,	-0.02	,	-0.01	,	0.05	,	0.1	,	0.01	,	0.03	,	0	, new List<int>() {	77	}, new List<int>(){		}	),
new News( 	77	,	"Confirma el Presidente el nuevo gabinete"	,	"El nuevo gabinete estará conformado por diferentes amigos del nuevo Presidente."	,	""	,	-0.04	,	-0.01	,	0.01	,	0.02	,	0.01	,	0.03	,	0	, new List<int>() {		}, new List<int>(){		}	),
...
new News( 	84	,	"Autopsia de Palometa"	,	"Los resultados indican que se trataría de un magnicidio, servicios de inteligencia de Albatros, sospechados."	,	""	,	0.03	,	0.06	,	-0.03	,	-0.02	,	-0.1	,	-0.02	,	83	, new List<int>() {		}, new List<int>(){		}	),
new News( 	85	,	"La autopsia de Palometa es un circo"	,	"Expertos internacionales indican que la autopsia es un circo, que indiscutiblemente fue suicidio por la situación en la que dejó el país."	,	""	,	-0.04	,	-0.01	,	0.01	,	0.02	,	0.01	,	0.03	,	83	, new List<int>() {		}, new List<int>(){		}	),
new News( 	86	,	"Inflación?"	,	"Los precios empiezan a incrementarse en el régimen Albatrosista."	,	""	,	0.03	,	0.06	,	-0.03	,	-0.02	,	-0.1	,	-0.02	,	0	, new List<int>() {		}, new List<int>(){		}	),
...
new News( 	88	,	"Nuevos jueces"	,	"El gobierno ha designado nuevos jueces que responderían directamente al régimen Albatrosista."	,	""	,	0.03	,	0.06	,	-0.03	,	-0.02	,	-0.1	,	-0.02	,	0	, new List<int>() {		}, new List<int>(){		}	),
new News( 	89	,	"Juicio a dirigentes de la oposición"	,	"Nuevos jueces albatrosistas designados por sorteo para juzgar a dirigentes de la oposición. Fallo inminente."	,	""	,	0.03	,	0.06	,	-0.03	,	-0.02	,	-0.1	,	-0.02	,	88	, new List<int>() {		}, new List<int>(){		}	),
new News( 	90	,	"Traición a la Patria"	,	"Dirigentes de la oposición al régimen albatrosista son encontrados culpables de traición a la Patria por los flamantes jueces."	,	""	,	0.03	,	0.06	,	-0.03	,	-0.02	,	-0.1	,	-0.02	,	89	, new List<int>() {		}, new List<int>(){		}	),
    };
